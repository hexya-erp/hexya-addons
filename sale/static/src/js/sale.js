hexya.define('sale.sale_teams_dashboard', function (require) {
"use strict";
...
KanbanRecord.include({
    events: _.defaults({
        'click .sale_teams_target_definition': 'on_sale_teams_target_click',
    }, KanbanRecord.prototype.events),

    on_sale_teams_target_click: function(ev) {
        ev.preventDefault();
