...
func init() {
	...
	pool.DecimalPrecision().AddFields(map[string]models.FieldDefinition{
		...
		"Digits": models.IntegerField{String: "Digits", Required: true, Default: models.DefaultValue(2), GoType: new(int)},
	})
	...
	pool.DecimalPrecision().Methods().PrecisionGet().DeclareMethod(
		...
		func(rs pool.DecimalPrecisionSet, application string) int {
