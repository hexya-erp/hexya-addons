...
func init() {
	...
	pool.AccountConfigSettings().AddFields(map[string]models.FieldDefinition{
		...
		"ModuleAccountBankStatementImportQif": models.BooleanField{String: "Import .qif files" /*["Import .qif files"]*/, Help: "Get your bank statements from your bank and import them in Odoo in the .QIF format.\n'#~#~# '-This installs the module account_bank_statement_import_qif."},
		"ModuleAccountBankStatementImportOfx": models.BooleanField{String: "Import in .ofx format" /*["Import in .ofx format"]*/, Help: "Get your bank statements from your bank and import them in Odoo in the .OFX format.\n'#~#~# '-This installs the module account_bank_statement_import_ofx."},
		"ModuleAccountBankStatementImportCsv": models.BooleanField{String: "Import in .csv format" /*["Import in .csv format"]*/, Help: "Get your bank statements from your bank and import them in Odoo in the .CSV format.\n'#~#~# '-This installs the module account_bank_statement_import_csv."},
